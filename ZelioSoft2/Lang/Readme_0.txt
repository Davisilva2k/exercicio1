...
Améliorations de la cybersécurité :
	o Protection contre certains fichiers incorrects d'application Zeliosoft (CVE-2018-7817, CVE-2018-7818)
...
Ajout fonction métier PID (AFB)
Driver pour le nouveau cable SR2USB01 (USB01_H2)
Correction des problèmes de transfert sous Windows 10
Intégration du SESU (Schneider Electric Software Update)
